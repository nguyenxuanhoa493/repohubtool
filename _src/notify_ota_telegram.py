...
def send_ota_notification(version=None, note_vi=None):
    ...
    msg_lines = [
        ...
        "• 🤖 <b>Trợ lý RetroHub AI (Web 8888):</b> Trò chuyện tư vấn game, tra cứu System Prompt, xem log máy & AI thực thi lệnh Linux trực tiếp trên máy TrimUI.",
        "• ⚙️ <b>Modal Thoát & Quản lý Dịch vụ:</b> Phím tức thì <code>[A]</code> Thoát hẳn, <code>[B]</code> Hủy/Ở lại, <code>[X]</code> Đổi ON/OFF dịch vụ chạy nền (SSH, SFTP, Web, Stream).",
        "• ❄️ <b>Chống nóng máy khi Tắt màn hình:</b> Nhận diện tắt màn hình phần cứng, hạ CPU xuống &lt;0.1% giúp máy luôn mát mẻ và chống sập nguồn.",
