...
FEATURES = [
    ("kho-game",
     ("Game library", "40,090 titles from several sources, filtered by system and by source"),
     ("Kho game", "40.090 tựa từ nhiều nguồn, lọc theo hệ máy và theo nguồn")),
    ("sftp",
    ...
    ("java",
     ("Java J2ME games", "2,832 games in 27 shelves, with key mapping and resolution folders"),
     ("Game Java J2ME", "2.832 game chia 27 nhóm, gán phím và chọn độ phân giải")),
    ("cap-nhat",
...
T = {
 "en": {
  ...
  "full_p": "The app, 40,090 games and the Java J2ME emulator. Pick this if you want to play Java games.",
 ...
 "vi": {
  ...
  "full_p": "Ứng dụng, kho 40.090 game và bộ giả lập Java J2ME. Chọn bản này nếu bạn muốn chơi game Java.",
