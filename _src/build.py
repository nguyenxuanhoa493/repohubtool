...
T = {
 "en": {
  ...
  "hero_badge": "New Release v2.33: Theme Store Grid 3x2, Web UI Bugfixes & Boxart Scaling",
  "nav_home": "RetroHub",
  ...
  "java_guide": ('Playing Java games? There is a separate guide: '
                 '<a href="/java/" style="color:var(--accent)">Playing Java J2ME games on RetroHub</a> '
                 '— resolution folders, device profiles, key layout and rendering modes.'),
  "h_os": "Supported handhelds",
  "sup_p": "RetroHub is a personal project, free to use and distribute. If you find it useful, buying me a coffee keeps me going.",
  "bank": "Bank", "holder": "Account holder", "acct": "Account number",
  "bmc": "Buy me a coffee", "bmc_sub": "Card & PayPal (international)",
  "bank_hdr": "Direct bank transfer (Vietnam)",
  "who_role": "Author of RetroHub",
  "who_p": "Questions, bug reports and suggestions are all welcome in the chat group — I read and reply there. For direct contact, use any of the options below.",
 ...
 "vi": {
  ...
  "hero_badge": "Bản mới v2.33: Theme Store Grid 3x2, Sửa lỗi Web UI & Khung ảnh Game",
  "nav_home": "RetroHub",
  "dls": "lượt tải",
