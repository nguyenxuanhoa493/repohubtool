...
T = {
 "en": {
  ...
  "hero_badge": "Web Manager AI Assistant: Shell Command Fix & Quick Debug Scanner",
  "nav_home": "RetroHub",
 ...
 "vi": {
  ...
  "hero_badge": "Trợ lý AI Web Manager: Sửa lỗi mã hóa Shell & Nút Quét Log lỗi 1 chạm",
  "nav_home": "RetroHub",
  "dls": "lượt tải",
