...
[CÁC TRƯỜNG HỢP"""
content = re.sub(old_prompt_section, lambda m: new_prompt_section, content, flags=re.DOTALL)
...
new_exec_block = r"""        async function executeAllAiCommands(e, b64Cmds) {
...
content = re.sub(old_exec_block, lambda m: new_exec_block, content, flags=re.DOTALL)
